...
| Normalised difference trophic index (NDTI) | Normalised difference between the number of S1 (linear chains) and S2 (omnivory) motifs $(S1 - S2)/(S1 + S2)$ | @milo2002; @dansereau2024 |
| Normalised difference competition index (NDCI) | Normalised difference between the number of S4 (exploitative competition) and S5 (apparent competition) motifs $(S4 - S5)/(S4 + S5)$ | @milo2002; @dansereau2024 |
