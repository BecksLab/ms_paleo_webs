...
> Is it sound to try and unpack the 'pairwise differences' between the different structural metrics as well (or some) as this will allow us to say e.g. Niche and PFIM might recover the same connectance but differ in vulnerability.
...
Here we will look at extinctions of the different paleo TSS [@gupta2022] and $R_{50}$ [@jonsson2015]
