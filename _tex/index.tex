...
among models. For connectance, the model-specific smooth terms were all
significant (\emph{e.g.,} PFIM: EDF = 2.99, F = 113.8, p \textless{}
0.001; ADBM: EDF = 2.92, F = 22.6, p \textless{} 0.001), indicating
distinct temporal patterns across reconstruction approaches. Trophic
level trajectories also differed among models (PFIM: EDF = 2.96, F =
36.7, p \textless{} 0.001; Niche: EDF = 2.96, F = 94.9, p \textless{}
0.001). Deterministic approaches, such as PFIM, produced more consistent
and smooth trajectories, whereas stochastic, theory-driven models
(niche, ADBM, ATN) displayed greater variability in timing and magnitude
of structural change. These results demonstrate that inferred pathways
of collapse, trophic bottlenecks, and secondary extinctions are highly
