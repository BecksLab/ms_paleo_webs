...
## Table S7. Full generalized additive model (GAM) results for network-level metrics.
...
## Table S8. ANOVA comparisons of shared versus model-specific GAM smooths for all network-level metrics.
